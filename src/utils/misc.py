...
class MetricLogger(object):
    def __init__(self, log_dir, delimiter="\t"):
        ...
        if os.path.isfile(os.path.join(log_dir, "log.txt")):
            ...
            self.log = open(os.path.join(log_dir, "log.txt"), "w")
...
def hungarian_matching(scores, matching_threshold=0.5, sigmoid=False):
    """ find active matching from detection to track given a score matrix
    
    Args:
        scores: [n_tracks, n_detections], matching score
